<div class="pb-10 text-gray-100  w-full md:px-8 px-0 ">
    ...
    <div class="mx-auto py-6">
        <form wire:submit.prevent='leerDatosForm'>
            ...
            <div class="w-full">
                <input type="submit"
                    class="bg-emerald-600 hover:bg-emerald-700 transition-colors text-white text-lg font-bold px-10 py-2 rounded-xl cursor-pointer uppercase w-full "
                    value="Buscar" />
            </div>
        </form>
    </div>
