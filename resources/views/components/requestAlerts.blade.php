@if (isset($solicitudes))
    <section class="flex justify-center w-full px-0 md:px-8">
        <a href="{{ route('admin.rq.index', $branch) }}"
            class="inline-flex items-center justify-center md:justify-between whitespace-nowrap rounded-xl py-6 align-middle font-semibold transition-all duration-300 ease-in-out stroke-white text-white
            ...
            <div
                class=" hidden sm:flex relative box-content items-center justify-center overflow-hidden rounded-full size-8  bg-transparent stroke-white border-white  border-[2.5px]">
