    ...
    <div class="space-y-6 w-full py-8">
        ...
        <section class="flex justify-center w-full px-0 md:px-8">
            <a href="{{ route('admin.gg.indexGS') }}"
                class="inline-flex items-center justify-center whitespace-nowrap rounded-xl py-6 align-middle font-semibold transition-all duration-300 ease-in-out disabled:cursor-not-allowed stroke-white text-white
