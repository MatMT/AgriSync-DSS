...
@section('contenido')
<section class="m-auto flex max-w-screen-2xl grow flex-col-reverse items-center justify-start lg:flex-row">
        <div class="flex flex-1 flex-col items-start gap-12 px-3 pb-6 md:pb-12 lg:px-24 lg:pb-0">
            <div class="flex max-w-lg flex-col gap-6">
                ...
                <h4 class="text-lg font-normal leading-7 text-slate-500">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eveniet sequi quaerat error ipsa facilis, sit molestiae voluptates consequuntur veniam hic modi? Quae facere corrupti provident excepturi illum minima quasi, nostrum itaque consectetur vitae atque. Id laboriosam eligendi odit rerum nemo.</h4>
            </div>
            <div class="flex gap-4">
                <button type="button" class="group inline-flex items-center justify-center whitespace-nowrap rounded-lg py-2 align-middle text-sm font-semibold leading-none transition-all duration-300 ease-in-out disabled:cursor-not-allowed bg-blue-700 stroke-white px-6 text-white hover:bg-blue-950 h-[42px] min-w-[42px] gap-2 disabled:bg-slate-100 disabled:stroke-slate-400 disabled:text-slate-400 disabled:hover:bg-slate-100">
    ...
    <hr>
    <div class="flex flex-col gap-12 m-auto max-w-screen-2xl py-16 px-8 lg:px-24">
    <!-- Sección de Misión -->
    <div class="flex flex-col items-center lg:flex-row lg:items-start lg:justify-between">
        <div class="lg:w-1/2">
            ...
            <p class="text-slate-500 mt-2 lg:mt-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et nostrum veritatis
    ...
    <div class="flex flex-col items-center lg:flex-row-reverse lg:items-start lg:justify-between">
        <div class="lg:w-1/2">
            ...
            <p class="text-slate-500 mt-2 lg:mt-0">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vel voluptatibus autem
    ...
    <div class="flex-auto max-w-md bg-white rounded-lg overflow-hidden shadow-lg mx-4 my-12 transition duration-300 transform hover:scale-105">
        ...
        <div class="p-6">
            ...
            <p class="text-gray-700 text-base mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo obcaecati porro perspiciatis quae. Distinctio, esse. Fugit, unde ipsam. Enim, minima.</p>
            <button class="bg-gray-800 text-white w-full py-2 rounded-md hover:bg-gray-700 transition duration-300">Ver más</button>
        </div>
    </div>
    <div class="flex-auto max-w-md bg-white rounded-lg overflow-hidden shadow-lg mx-4 my-12 transition duration-300 transform hover:scale-105">
        <img src="img/depositar.jpg" alt="Depositar" class="w-full h-48 object-cover">
